...
def group1_baseplate_588nm(x=0, y=0, angle=0):
    ...
    beam_588nm = baseplate.add_beam_path(x=gap, y=input_y_588nm + 0.05 * layout.inch - (input_y_588nm - 0.5 * layout.inch), angle=layout.cardinal['right'])
    #print(beam_588nm.BasePlacement.__dict__)
    baseplate.place_element("ECDL_588nm", optomech.ECDL, x=gap, y=input_y_588nm - (input_y_588nm - 0.5 * layout.inch), stage_thickness=1, stage_length=50,  angle=layout.cardinal['right'], littrow_angle=littrow_angle_588nm, cover_box=True)
    ...
    baseplate.place_element("Output Fiberport beam_588nm", optomech.fiberport_mount_hca3, x=gap, y=3.5 *layout.inch - (input_y_588nm - 0.5 * layout.inch), angle=layout.cardinal['right'])
    master_doc.recompute()
...
def group2_baseplate_405nm(x=0, y=0, angle=0):
    ...
    baseplate.place_element("ECDL_405nm", optomech.ECDL, x=gap, y=input_y_405nm_1 - (input_y_405nm_1 - 0.5 * layout.inch), stage_thickness=1, stage_length=50,  angle=layout.cardinal['right'], littrow_angle=littrow_angle_405nm, cover_box=True)

    beam_405nm = baseplate.add_beam_path(x=gap, y=input_y_405nm_1 + 0.05 * layout.inch - (input_y_405nm_1 - 0.5 * layout.inch), angle=layout.cardinal['right'])
    ...
    baseplate.place_element("Output Fiberport_beam_403nm", optomech.fiberport_mount_hca3, x=gap, y=y_offset+(1.75*3*layout.inch) - (input_y_405nm_1 - 0.5 * layout.inch), angle=layout.cardinal['right'])    
...
def group3_baseplate_850nm(x=0, y=0, angle=0):
    ...
    baseplate.place_element("ECDL_850nm", optomech.ECDL, x=gap, y=input_y_850nm - (input_y_850nm - 0.5 * layout.inch), stage_thickness=1, stage_length=50,  angle=layout.cardinal['right'], littrow_angle=littrow_angle_850nm, cover_box=True)

    beam_850nm = baseplate.add_beam_path(x=gap, y=input_y_850nm - (input_y_850nm - 0.5 * layout.inch), angle=layout.cardinal['right'])
    ...
    # Adding AOM from ca 40 example
    #aom_866nm = baseplate.place_element_along_beam("AOM_866nm", optomech.isomet_1205c_on_km100pm, beam, beam_index=0b11, distance=50, angle=layout.cardinal['left'], forward_direction=-1, backward_direction=1, diffraction_angle=0.01)
    ...
    # Adding AOM from ca 40 example
    #aom_422nm = baseplate.place_element_along_beam("AOM_422nm", optomech.isomet_1205c_on_km100pm, beam, beam_index=0b11, distance=50, angle=layout.cardinal['left'], forward_direction=-1, backward_direction=1, diffraction_angle=0.01)
    #created_objects["AOM_422nm"] = aom_422nm

    baseplate.place_element("Output Fiberport_beam_422nm", optomech.fiberport_mount_hca3, x=gap, y=input_y_850nm-2+(1.40*3*layout.inch) - (input_y_850nm - 0.5 * layout.inch), angle=layout.cardinal['right'])    
